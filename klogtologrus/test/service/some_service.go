...
import (
	...
	_ "github.com/akaitux/kube-client/klogtologrus" // plug in JSON logs adapter
	klog_powered_lib "github.com/akaitux/kube-client/klogtologrus/test/klog-powered-lib"
)
